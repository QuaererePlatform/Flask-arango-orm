...
class TestArangoORM:
    ...
    #     mock_current_app.config = {'ARANGODB_DATABASE': arango_db, 'ARANGODB_USER': arango_user,
    #                                'ARANGODB_PASSWORD': arango_passwd, 'ARANGODB_CLUSTER': False,
    #                                'ARANGODB_HOST': ARANGODB_HOST}
    #     arango = ArangoORM()
    #     arango.init_app(mock_current_app)
    #     arango.connect()
    ...
    #     mock_current_app.config = {'ARANGODB_DATABASE': arango_db, 'ARANGODB_USER': arango_user,
    #                                'ARANGODB_PASSWORD': arango_passwd, 'ARANGODB_CLUSTER': True,
    #                                'ARANGODB_HOST_POOL': host_pool}
    #     arango = ArangoORM()
    #     arango.init_app(mock_current_app)
    #     arango.connect()
